 ...
 * mouse_hook (bonus)
 * ------------------
 * Manipula eventos de roda do mouse para aplicar zoom centrado no ponto
 * do cursor (implementação movida para arquivo _bonus).
 */
 ...
 * motion_hook (bonus)
 * -------------------
 * Atualiza parâmetros do Julia com o movimento do cursor (quando aplicável).
 */
